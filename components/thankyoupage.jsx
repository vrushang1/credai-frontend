            ...
            <section className="thankyou-section">
                <div className="container">
                    <div className="title-block">
                        ...
                        <p>
                            Our team will do the analysis for you and a report
                            will be sent to your email address within 72 hrs.
                        </p>
                        <p className="small-text">
                            In case we need some more information, our team will
                            contact you
                        </p>
                        ...
                        <div className="custom-row">
                            <div className="custom-col left-col">
                                <div className="content-block">
                                    ...
                                    <p>
                                        you could be eligible for a business
                                        loan upto
                                    </p>
